...
fetch("./testData.json")
  ...
  .then(function (data) {
    appendData(data)  // The function calls itself here
  })
  .catch(function (err) {
    console.log(err);
  });
  ...
  function appendData(data) {
    ...
    // Here below is the Image JSON Structure but placing the URL in Ims src is better
    // =======================================================================//
    // const imgData = JSON.stringify(data.results[0].picture.large);
    // imgClientData.src = imgData;  
    // console.log(imgClientData)
    // ========================================================================//
        
        // This create element names are not conventional, just random names to store var
